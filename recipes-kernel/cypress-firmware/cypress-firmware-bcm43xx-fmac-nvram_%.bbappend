...
FILES:${PN}-bcm43439-1yn-sdio:append:dh-imx6ull-dhsom = " \
...
do_install:append:dh-imx6ull-dhcom-drc02 () {
	...
	ln -s brcmfmac43439-sdio.1YN.txt \
		${D}${nonarch_base_libdir}/firmware/brcm/brcmfmac43439-sdio.dh,imx6ull-dhcom-drc02.txt
}
...
FILES:${PN}-bcm43439-1yn-sdio:append:dh-imx6ull-dhcom-drc02 = " \
	${nonarch_base_libdir}/firmware/brcm/brcmfmac43439-sdio.dh,imx6ull-dhcom-drc02.txt \
	"
...
do_install:append:dh-imx6ull-dhcom-pdk2 () {
	...
	ln -s brcmfmac43439-sdio.1YN.txt \
		${D}${nonarch_base_libdir}/firmware/brcm/brcmfmac43439-sdio.dh,imx6ull-dhcom-pdk2.txt
}
...
FILES:${PN}-bcm43439-1yn-sdio:append:dh-imx6ull-dhcom-pdk2 = " \
	${nonarch_base_libdir}/firmware/brcm/brcmfmac43439-sdio.dh,imx6ull-dhcom-pdk2.txt \
	"
...
do_install:append:dh-imx6ull-dhcom-picoitx () {
	...
	ln -s brcmfmac43439-sdio.1YN.txt \
		${D}${nonarch_base_libdir}/firmware/brcm/brcmfmac43439-sdio.dh,imx6ull-dhcom-picoitx.txt
}
...
FILES:${PN}-bcm43439-1yn-sdio:append:dh-imx6ull-dhcom-picoitx = " \
	${nonarch_base_libdir}/firmware/brcm/brcmfmac43439-sdio.dh,imx6ull-dhcom-picoitx.txt \
	"
